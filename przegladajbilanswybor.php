<?php
	...
	if (!isset($_POST['date1']))
	{
		...
		$_SESSION['fr_data1'] = $data1;
		$_SESSION['fr_data2'] = $data2;
		//echo $data1;
		echo "FAIL";
				  ...
				  <div class="modal-body">
					...
					<form method="post" id="modalForm">
						...
						<div class="row d-flex justify-content-center align-items-center">								
							...
							<div class="col-auto">
								<input type="date" class="form-control" name="date1" maxlength="10" minlength="10">
							</div>							
							<div class="col-auto">
								<label for="date2" class="col-form-label">do:</label>
							</div>
							<div class="col-auto">
								<input type="date" class="form-control" name="date2" maxlength="10" minlength="10">
							</div>								  
						</div>						
					  	
						<button type="submit" class="btn btn-primary" data-bs-dismiss="modal" onclick="resetFunction()">Zatwierdź</button>
					</form>
					
				  </div>
				  <div class="modal-footer">
					<button type="button" class="btn btn-secondary" data-bs-dismiss="modal" onclick="location.href='przegladajbilanswybor.php'">Zamknij</button>
					<!--<button type="submit" class="btn btn-primary" data-bs-dismiss="modal" onclick="resetFunction()">Zatwierdź</button>-->
				  </div>
				</div>
			  </div>
