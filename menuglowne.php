...
<body>	
	...
	<main>	
		<div class="row">
			<div class="col-auto">
				<div class="greetings p-2" <?php echo $style;?>>
					<?php
						echo $message;
		...
		<div class="d-flex justify-content-center">			
				<div class="col-sm-6">				
					<p style="color: red; text-align: center; background-image: url('img/what-the-hex-dark.png');">
					<?php
						if (isset($_SESSION['e_wrongDateOrder']))
						{
							echo $_SESSION['e_wrongDateOrder'];
							unset($_SESSION['e_wrongDateOrder']);
						}
					?></p>			
				</div>			
			</div>
